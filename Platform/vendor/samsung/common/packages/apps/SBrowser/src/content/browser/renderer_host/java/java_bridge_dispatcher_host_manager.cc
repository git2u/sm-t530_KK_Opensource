...
bool JavaBridgeDispatcherHostManager::render_view_status = false;
...
void JavaBridgeDispatcherHostManager::RenderViewCreated(
  ...
  render_view_status = true;
}

void JavaBridgeDispatcherHostManager::RenderViewDeleted(
    RenderViewHost* render_view_host) {
  instances_.erase(render_view_host);
  render_view_status = false;
}

bool JavaBridgeDispatcherHostManager::GetRenderViewStatus() {
  return render_view_status;
}

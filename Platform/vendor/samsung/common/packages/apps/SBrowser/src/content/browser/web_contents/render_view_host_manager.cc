...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
	  MSC_MESSAGE("RVHM","RVHM","Navigating","");
#endif
...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
	MSC_NOTE(render_view_host_);
	MSC_NOTE(dest_render_view_host);
#endif
...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
  MSC_METHOD("RVHM","RVH","ViewMsg_SwapOut","");
#endif
...
#if defined(SBROWSER_PROCESS_PER_TAB_FOR_CHROME_SCHEMA)
...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
  MSC_METHOD("RVHM","WC","CreateRenderView","");
#endif
...
void RenderViewHostManager::CommitPending() {
  ...
  if (render_view_host_->GetView())
	{
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
		MSC_METHOD_NORMAL("RVHM", "RWHVA","Show",render_view_host_->GetView());
#endif
...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
	MSC_METHOD_NORMAL("RVHM", "RWHVA","Hide",old_render_view_host->GetView());
#endif
  ...
  #if defined(SBROWSER_GRAPHICS_MSC_TOOL)
	MSC_METHOD_NORMAL("RVHM", "WC","NotifySwappedFromRenderManager",""); 
#endif
}
...
#if defined(SBROWSER_GRAPHICS_MSC_TOOL)
    MSC_METHOD("RVHM","RVH","ViewMsg_Stop","");
   MSC_METHOD("RVH","RENDERER","ViewMsg_Stop","");
#endif

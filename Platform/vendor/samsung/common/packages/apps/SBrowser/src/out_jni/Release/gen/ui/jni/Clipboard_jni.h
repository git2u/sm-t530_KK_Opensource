...
// For
//     org/chromium/ui/Clipboard

#ifndef org_chromium_ui_Clipboard_JNI
#define org_chromium_ui_Clipboard_JNI
...
namespace {
const char kClipboardClassPath[] = "org/chromium/ui/Clipboard";
...
static base::subtle::AtomicWord g_Clipboard_hasPlainText = 0;
static jboolean Java_Clipboard_hasPlainText(JNIEnv* env, jobject obj) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_Clipboard_clazz);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
#endif  // org_chromium_ui_Clipboard_JNI

...
class LayerTreeHostImplClient {
 public:
  ...
  virtual void OnOverscrollOnImplThread(gfx::Vector2dF accumulated_root_overscroll_, 
                    gfx::Vector2dF current_fling_velocity_, bool hScroll, bool vScroll, gfx::SizeF size, float WebLayerY) = 0;
  virtual void DropEdgeGlowEffect(int axis) = 0;
#endif 
  ...
  virtual void setCommitBlockOnImplThread(bool blockState) = 0;
#endif
#if defined(SBROWSER_PAUSE_ANIMATION_ON_SCROLL_ZOOM)
  virtual void setGestureStateOnImplThread(bool gestureActive) = 0;
#endif
#if defined(SBROWSER_HIDE_URLBAR)
  virtual void DidHideUrlBarEventOnImplThread(int event, int event_data1, int event_data2) {}
#endif
...
virtual void FlingAnimationCompletedOnImplThread(bool page_end){}
#endif
...
class CC_EXPORT LayerTreeHostImpl : public InputHandler,
 ...
 public:
  ...
  virtual InputHandler::ScrollStatus FlingScrollBegin(double timeStampSeconds) OVERRIDE;
#else
...
#if defined(SBROWSER_FLING_END_NOTIFICATION_CANE)
  virtual void FlingAnimationCompleted() OVERRIDE;
#endif
...
#if   defined(SBROWSER_COMMIT_BLOCK_ONTOUCH)
    virtual void  setCommitBlock(bool blockState) OVERRIDE;
    virtual void setCommitBlockOnImplThread(bool blockState) OVERRIDE;
#endif
  ...
  void SetHighPriorityToRasterWorker(bool flag);
#endif
 ...
 public:
  ...
  virtual bool ShouldForceTileUploadsRequiredForActivationToComplete() const OVERRIDE;
  ...
  virtual void NeedToUpdateFrameInfo(bool enable) OVERRIDE;
#endif
...
#if defined(SBROWSER_HIDE_URLBAR)
  void SetLayerPositions(int web_y, int urlbar_y, int urlbar_height);
  float WebLayerY();
  float UrlBarLayerY();
  void SetUrlBarActive(bool active, bool override_allowed);
  bool urlbar_active() {return urlbar_active_;}
  bool scroll_inprogress() {return scroll_inprogress_;}
  void SetUrlBarUpdate(bool needsUpdate) {pending_urlbar_update_ = needsUpdate;}
  bool pending_urlbar_update() {return pending_urlbar_update_;}
  void SendUrlBarActiveAckIfNeeded();
#endif
#if defined(SBROWSER_DEFER_COMMITS_ON_GESTURE)
  void DeferCommitsOnGesture(bool defer_commits);
  void ChangeDeferCommitsStatusForGlow(bool did_scroll_x, bool did_scroll_y);
#endif
#if defined(SBROWSER_SKIP_MODIFYING_TILE_PRIORITY)
  void SetSkipModifyingTilePriority(bool skip) {skip_modifying_tile_priority_ = skip;}
  bool SkipModifyingTilePriority() {return skip_modifying_tile_priority_;}
#endif
 ...
 public:
...
#if defined(SBROWSER_SUPPORT_GLOW_EDGE_EFFECT)
  bool deactiveGlowOnTouchStart(){return deactive_glow_on_TouchStart;}
  void setDeactiveGlowOnTouchStart(bool deactive){ deactive_glow_on_TouchStart = deactive;}
  ...
  void SetGlowStatus(bool active){ glow_effect_active_= active;}
#endif
 ...
 private:
  ...
  bool set_hScrollbar_status;
  bool set_vScrollbar_status;
  float WebLayerY_previous;
  gfx::Size set_size_current;
  int accumulated_root_overscroll_y_current;
  int accumulated_root_overscroll_y_previous;
  int accumulated_root_overscroll_x_current;
  int accumulated_root_overscroll_x_previous;
  bool deactive_glow_on_TouchStart;
  bool block_glow_on_pinch;
  enum Axis { AXIS_X = 0, AXIS_Y, AXIS_XY };
  enum Event { Undefined = -1, GestureScrollBegin, GestureScrollUpdate, GestureScrollEnd, GesturePinchBegin, GesturePinchUpdate, GesturePinchEnd};
  Event event_type;  
  bool glow_effect_active_;
#endif
...
#if defined(SBROWSER_HIDE_URLBAR)
  bool urlbar_active_;
  bool urlbar_active_override_;  
  bool pending_urlbar_active_;
  bool scroll_inprogress_;
  bool sync_urlbar_active_;
  bool pending_urlbar_update_;
#endif
#if defined(SBROWSER_DEFER_COMMITS_ON_GESTURE)
  bool defer_commit_;
#endif
#if defined(SBROWSER_SKIP_MODIFYING_TILE_PRIORITY)
  bool skip_modifying_tile_priority_;
  float accumulated_scroll_delta;
#endif
#if defined(SBROWSER_BLOCK_SENDING_FRAME_MESSAGE)
  bool need_to_update_frame_info_;
#endif
  ...
  bool scroll_page_end;
#endif
#if defined(SBROWSER_GENERATING_FAKE_SCROLL_EVENT)
  gfx::Vector2dF m_fakeScrollUpdateEvent;
  gfx::Point fake_viewport_point;
#endif

...
const char kSoftBitmapHeight[]="soft-bitmap-height";
#endif

#if defined(SBROWSER_ENABLE_ADBLOCKER)
const char webAdBlockerEnabled[]="webadblocker-enabled";
#endif
// ----------------- kikin Modification Starts -----------------
#if defined(SBROWSER_KIKIN)
const char kEnableKikin[] = "enable-kikin";
#endif
// ----------------- kikin Modification Ends -------------------

#if defined(OS_ANDROID) && defined(SBROWSER_NATIVE_TEXTURE_UPLOAD)
// Disable Android native buffer-backed textures (GraphicBuffers) with zero-copy upload optimisations
const char kDisableNativeBufferTextures[]		= "disable-native-buffer-textures";
const char kEnableNativeBufferTextures[]		= "enable-native-buffer-textures";
#endif

// SAMSUNG: Ignore blocking in Single Buffer >>
// Disable Single Buffer Hint
const char kDisableSingleBufferHint[]		= "disable-single-buffer-hint";
const char kEnableSingleBufferHint[]		= "enable-single-buffer-hint";
// SAMSUNG: Ignore blocking in Single Buffer <<
#if defined(SBROWSER_POWER_SAVER_MODE_IMPL)
const char kEnablePowerSaverMode[] = "enable-power-saver-mode";
const char kDisableProgressiveImageDecoding[] = "disable-progressive-image-decoding";
const char kDisableGIFAnimation[] = "disable-gif-animation";
#endif

#if defined(SBROWSER_ENABLE_APPNAP)  
const char kEnableAppNap[] = "enable-appnap";
#endif
}  // namespace switches

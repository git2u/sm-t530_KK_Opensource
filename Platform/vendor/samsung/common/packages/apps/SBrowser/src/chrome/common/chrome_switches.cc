...
// Enable session cache to store no-store entries in memory to be reused
// in back-forward navigation.
const char kEnableSBrowserSessionCache[] 	= "enable-sbrowser-session-cache";
#endif

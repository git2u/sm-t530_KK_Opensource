...
#define SBROWSER_SELECTIVE_AA_PATCH_V2 1
...
public:
    ...
    */
    ...
    void setIsCurves(bool bIsCurves) {
		fIsCurves = bIsCurves;
    }
	
    bool isCurves() const { return fIsCurves; }
#endif
    ...
    */
    ...
    void arcTo(const SkPoint p1, const SkPoint p2, SkScalar radiusX, SkScalar radiusY) {
        this->arcTo(p1.fX, p1.fY, p2.fX, p2.fY, radiusX, radiusY);
    }	
...
#ifdef SBROWSER_SELECTIVE_AA_PATCH_V2
	    kIsCurves_SerializationShift = 28, // requires 1 bits	
#endif

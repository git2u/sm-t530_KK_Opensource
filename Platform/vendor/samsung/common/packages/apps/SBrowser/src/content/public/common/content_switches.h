...
CONTENT_EXPORT extern const char kEnablePowerSaverMode[];
CONTENT_EXPORT extern const char kDisableProgressiveImageDecoding[];
CONTENT_EXPORT extern const char kDisableGIFAnimation[];
#endif
#if defined(SBROWSER_ENABLE_APPNAP)  
CONTENT_EXPORT extern const char kEnableAppNap[];
#endif
#if defined(OS_ANDROID)
...
extern const char kDisableNativeBufferTextures[];
extern const char kEnableNativeBufferTextures[];
#endif

// SAMSUNG: Ignore blocking in Single Buffer >>
extern const char kDisableSingleBufferHint[];
extern const char kEnableSingleBufferHint[];
// SAMSUNG: Ignore blocking in Single Buffer <<
#endif
...
CONTENT_EXPORT extern const char kSoftBitmapHeight[];
#endif

#if defined(SBROWSER_ENABLE_ADBLOCKER)
CONTENT_EXPORT extern const char webAdBlockerEnabled[];
#endif
// ----------------- kikin Modification Starts -----------------
#if defined(SBROWSER_KIKIN)
extern const char kEnableKikin[];
#endif

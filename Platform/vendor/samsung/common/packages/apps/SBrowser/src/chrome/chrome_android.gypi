...
#        'android/testshell/chrome_main_delegate_testshell_android.h',
	...
	{
        'sources': [
		'app/android/sbr/sbr_chrome_main_delegate_android.cc',
        	'app/android/sbr/sbr_chrome_main_delegate_android.h',
		],
	}],
        [ 'order_profiling!=0', {
          'conditions': [
...
#        'app/android/sbr/sbr_chrome_main_delegate_android.h',
    ...
    },
    {
      ...
      'copies': [
        {
          'destination': '<(sbrowser_pak_output_folder)',
          'files': [
            '<@(chrome_android_pak_input_resources)',
          ],
        }
...
#        'android/testshell/testshell_stubs.cc',
      ...
      'link_settings': {
        'libraries': [
          '<(PRODUCT_DIR)/libsbr_content_native.a',
          '<(PRODUCT_DIR)/libsbr_chrome_native.a',
        ],
      },
...
###################### kikin Modifications Starts ######################
        ['enable_sbrowser_kikin==1', {
          'variables': {
            'native_libs_paths': [
              '<(SHARED_LIB_DIR)/libkikin.so', # kikin Smart Selection Library
            ],
          },
        }],

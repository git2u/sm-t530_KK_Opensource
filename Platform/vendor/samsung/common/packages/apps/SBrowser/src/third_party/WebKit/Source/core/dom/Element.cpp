...
#if defined(SBROWSER_FORM_NAVIGATION)
void Element::scrollIntoCenter(bool always)
{
    document()->updateLayoutIgnorePendingStylesheets();
    ...
    LayoutRect bounds = boundingBox();
    if (always)
        renderer()->enclosingLayer()->scrollRectToVisible(bounds, ScrollAlignment::alignCenterAlways, ScrollAlignment::alignCenterAlways);
    else
        renderer()->enclosingLayer()->scrollRectToVisible(bounds, ScrollAlignment::alignCenterIfNeeded, ScrollAlignment::alignCenterAlways);
}
#endif

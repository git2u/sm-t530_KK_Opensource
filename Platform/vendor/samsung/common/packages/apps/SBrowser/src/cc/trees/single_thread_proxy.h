...
class SingleThreadProxy : public Proxy, LayerTreeHostImplClient {
 public:
  ...
  virtual bool CommitPendingForTesting() OVERRIDE;
    ...
    virtual void setCommitBlockOnImplThread(bool blockState) {}
#endif
  ...
  virtual void OnOverscrollOnImplThread(gfx::Vector2dF accumulated_root_overscroll_, 
                gfx::Vector2dF current_fling_velocity_, bool hScroll, bool vScroll, gfx::SizeF, float WebLayerY) OVERRIDE {}

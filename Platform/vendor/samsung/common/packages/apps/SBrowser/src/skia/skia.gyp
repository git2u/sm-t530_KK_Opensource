  ...
  'targets': [
    {
      ...
      'variables': {
        'conditions': [
          ['OS== "ios"', {
            'skia_support_gpu': 0,
            'skia_triangulate_path_rendering': 0,
          }, {
            'skia_support_gpu': 1,
            'skia_triangulate_path_rendering': 0,
          }],
      ...
      'conditions': [
        ...
        [ 'skia_triangulate_path_rendering', {
          'sources': [
              '<(skia_src_path)/gpu/GrTriangulatePathRenderer.cpp',
              '<(skia_src_path)/gpu/GrTriangulatePathRenderer.h',
              '<(skia_src_path)/gpu/triangulate.cpp',
              '<(skia_src_path)/gpu/triangulate.h'
          ],
          'defines': [
            'GR_TRIANGULATE_PATH_RENDERER=1',
          ],
        }],
      ...
      'conditions': [
        ...
        [ 'target_arch == "arm"', {
          ...
          'sources': [
            ...
            '../third_party/skia/src/opts/S32A_D565_Opaque_arm.S',
            '../third_party/skia/src/opts/S32A_Opaque_BlitRow32_arm.S',
            '../third_party/skia/src/opts/S32A_Blend_BlitRow32_arm.S',
          ],
        }],

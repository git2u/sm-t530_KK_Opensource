...
GPU_EXPORT extern  const char kEnableSingleCompositor[];
GPU_EXPORT extern  const char kDisableSingleCompositor[];
GPU_EXPORT extern  const char kEnsureSurfaceWorkaround[];
GPU_EXPORT extern  const char kDisableSurfaceWorkaround[];
#endif

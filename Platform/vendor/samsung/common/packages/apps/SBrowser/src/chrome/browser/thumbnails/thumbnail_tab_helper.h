...
class ThumbnailTabHelper
 ...
 public:
  ...
  void UpdateThumbnailEx(scoped_refptr<thumbnails::ThumbnailingContext> context,
                         const  SkBitmap&  thumbnail);
  static ThumbnailTabHelper*  GetThumbnailTabHelper(content::WebContents* webContents)
  {
   	return new ThumbnailTabHelper(webContents);
  };

...
IPC_STRUCT_TRAITS_BEGIN(WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(kikin_enabled)
  #endif
  ...
  IPC_STRUCT_TRAITS_MEMBER(disable_progressive_image_decoding)
  IPC_STRUCT_TRAITS_MEMBER(disable_gif_animation)
  IPC_STRUCT_TRAITS_MEMBER(disable_filter_bitmap)
  IPC_STRUCT_TRAITS_MEMBER(enable_bgcolor_Offwhite)
  IPC_STRUCT_TRAITS_MEMBER(enable_bgcolor_lightgrey)
  IPC_STRUCT_TRAITS_MEMBER(enable_bgcolor_grey)
#endif
#if defined(SBROWSER_ENABLE_APPNAP)  
	IPC_STRUCT_TRAITS_MEMBER(enable_appnap)
#endif
  ...
  IPC_STRUCT_TRAITS_MEMBER(fontboosting_mode_enabled)
#endif
#if defined(SBROWSER_CHROME_NATIVE_PREFERENCES)
  IPC_STRUCT_TRAITS_MEMBER(overview_mode_enabled)   
#endif // SBROWSER_CHROME_NATIVE_PREFERENCES
 #if defined(SBROWSER_BINGSEARCH_ENGINE_SET_VIA_JAVASCRIPT)
  IPC_STRUCT_TRAITS_MEMBER(is_bing_as_default_search_engine)
#endif
#if defined(SBROWSER_IMIDEO_PREFERENCES)
  IPC_STRUCT_TRAITS_MEMBER(imideo_debug_mode)
#endif
#endif
IPC_STRUCT_TRAITS_END()

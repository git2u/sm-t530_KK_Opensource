...
#ifndef CONTENT_BROWSER_ANDROID_ANDROID_STREAM_READER_URL_REQUEST_JOB_H_
#define CONTENT_BROWSER_ANDROID_ANDROID_STREAM_READER_URL_REQUEST_JOB_H_
...
class AndroidStreamReaderURLRequestJob : public net::URLRequestJob {
 public:
  ...
  class Delegate {
   public:
    ...
    virtual scoped_ptr<content::InputStream> OpenInputStream(
        JNIEnv* env,
        const GURL& url) = 0;
 ...
 protected:
  ...
  virtual scoped_ptr<content::InputStreamReader>
      CreateStreamReader(content::InputStream* stream);
 ...
 private:
  ...
  void OnInputStreamOpened(
      scoped_ptr<Delegate> delegate,
      scoped_ptr<content::InputStream> input_stream);
...
#endif  // CONTENT_BROWSER_ANDROID_ANDROID_STREAM_READER_URL_REQUEST_JOB_H_
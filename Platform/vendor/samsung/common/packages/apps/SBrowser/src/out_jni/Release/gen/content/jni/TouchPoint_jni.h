...
namespace {
const char kTouchPointClassPath[] = "org/chromium/content/browser/TouchPoint";
...
static base::subtle::AtomicWord g_TouchPoint_getSize = 0;
static jdouble Java_TouchPoint_getSize(JNIEnv* env, jobject obj) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_TouchPoint_clazz);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static jdouble Java_TouchPoint_getPressure(JNIEnv* env, jobject obj) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_TouchPoint_clazz);
  jmethodID method_id =
      base::android::MethodID::LazyGet<

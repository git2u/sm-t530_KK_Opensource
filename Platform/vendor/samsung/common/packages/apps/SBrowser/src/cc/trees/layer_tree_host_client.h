...
class LayerTreeHostClient {
 public:
  ...
  virtual void DidFailToInitializeOutputSurface() {}
    ...
    virtual void setGestureState(bool gestureActive) = 0;
#endif
#if defined(SBROWSER_HIDE_URLBAR)
  //event : 1 -> SetUrlBarTextureAck, 2 -> SetUrlBarActiveAck, 4 -> ScrollEndNotify
  virtual  void HideUrlBarEventNotify(int event, int event_data1, int event_data2) {}
#endif
#if defined(SBROWSER_FLING_END_NOTIFICATION_CANE)
  virtual void FlingAnimationCompleted(bool page_end){}
#endif
#if defined(SBROWSER_DEFER_COMMITS_ON_GESTURE)
  virtual void SetDeferCommitsOnGesture(bool deferCommits) {}
#endif
 protected:

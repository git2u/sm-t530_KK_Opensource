...
TEST_F(GLES2ImplementationTest, RenderbufferStorageMultisampleIMG) {
  struct Cmds {
  ...
  gl_->RenderbufferStorageMultisampleIMG(GL_RENDERBUFFER, 2, GL_RGBA4, 4, 5);
  EXPECT_EQ(0, memcmp(&expected, commands_, sizeof(expected)));
}
...
TEST_F(GLES2ImplementationTest, FramebufferTexture2DMultisampleIMG) {
  struct Cmds {

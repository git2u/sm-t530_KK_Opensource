...
void ContextMenuHandler::HandleShowContextMenu(
  ...
  content::ContentViewCoreImpl* content_view_core =
      content::ContentViewCoreImpl::FromWebContents(web_ui()->GetWebContents());
  content_view_core->GetSbrContentViewCore()->ShowCustomContextMenu(menu,

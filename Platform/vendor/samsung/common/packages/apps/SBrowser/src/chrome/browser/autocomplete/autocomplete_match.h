...
struct AutocompleteMatch {
  ...
  enum Type {
    ...
    VOICE_SUGGEST,           //These 3 dummy iteams are used in Java side(SBrowserSuggestions.java)
    SAVEPAGE_SUGGEST,        //SuggestionListAdapater.java:getSuggestionIconType should
    OPERATOR_SUGGEST,        //use enum rather than numbers
    SEARCH_RESULT_NAVSUGGEST, //A search result user selected for the search terms containing input
#endif
    NUM_TYPES,
  };

...
#ifdef SBROWSER_DISABLE_HISTOGRAM
#define CACHE_HISTOGRAM_CUSTOM_COUNTS(name, sample, min, max, bucket_count) (void(0)) 
...
#ifdef SBROWSER_DISABLE_HISTOGRAM
#define CACHE_HISTOGRAM_CUSTOM_TIMES(name, sample, min, max, bucket_count) (void(0)) 
...
#ifdef SBROWSER_DISABLE_HISTOGRAM
#define CACHE_HISTOGRAM_ENUMERATION(name, sample, boundary_value) (void(0)) 

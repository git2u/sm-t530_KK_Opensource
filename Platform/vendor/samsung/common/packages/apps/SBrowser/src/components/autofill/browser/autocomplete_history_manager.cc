...
#include "chrome/browser/android/sbr/preferences/sbr_pref_names.h"
#endif 
...
AutocompleteHistoryManager::AutocompleteHistoryManager(
  ...
  autofill_enabled_.Init(
   ...
   #if defined(SBROWSER_CHROME_NATIVE_PREFERENCES)
   remember_formdata_enabled_.Init(
     sbrprefs::kRememberFormDataEnabled,
     components::UserPrefs::Get(browser_context_));

...
#if defined(OS_ANDROID)
#if defined(SBROWSER_ENABLE_WEBAUDIO_DEFAULT)
  WebRuntimeFeatures::enableWebAudio(true);
#else
  WebRuntimeFeatures::enableWebAudio(false);
#endif  // SBROWSER_ENABLE_WEBAUDIO_DEFAULT
...
#if defined(SBROWSER_CQ_RINGMARK)  
...
static void AdjustRuntimeFeaturesFromArgs(const CommandLine& command_line) {
 ...
 #if defined(ENABLE_INPUT_TYPE_DATETIME_INCOMPLETE)  //Enable input type = datetime

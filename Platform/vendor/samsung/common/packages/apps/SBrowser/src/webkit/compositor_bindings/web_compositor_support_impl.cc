...
WebExternalTextureLayer* WebCompositorSupportImpl::createExternalTextureLayer(
    ...
    bool single_buffer) { // SAMSUNG: Ignore blocking in Single Buffer
  // SAMSUNG: Ignore blocking in Single Buffer >>
  // WAS: return new WebExternalTextureLayerImpl(client, false);
  return new WebExternalTextureLayerImpl(client, false, single_buffer);
  // SAMSUNG: Ignore blocking in Single Buffer <<
}
...
WebCompositorSupportImpl::createExternalTextureLayerForMailbox(
    WebExternalTextureLayerClient* client) {
  // SAMSUNG: Ignore blocking in Single Buffer >>
  // WAS: return new WebExternalTextureLayerImpl(client, true);
  return new WebExternalTextureLayerImpl(client, true, false);
  // SAMSUNG: Ignore blocking in Single Buffer <<
}

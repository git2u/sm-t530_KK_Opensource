...
class GPU_EXPORT GLES2Decoder : public base::SupportsWeakPtr<GLES2Decoder>,
                                ...
                                public SharedMemoryPoolInterface {
#else
class GPU_EXPORT GLES2Decoder : public base::SupportsWeakPtr<GLES2Decoder>,
                                public CommonDecoder {
#endif
 public:
  ...
  // Creates a decoder.
#if defined(SBROWSER_IPC_SHARED_MEMORY_TRACKING)
  static GLES2Decoder* Create(ContextGroup* group, content::GpuCommandBufferStub* gpuCmdBufferStub = NULL);
#else
  ...
  // Set file descriptors for to be allocated texture
  virtual void SetFileDescriptors(uint32 texid, int* fd_array, int fd_count) = 0;
#endif

...
class TopSitesImpl : public TopSites {
 public:
  ...
  virtual bool IsBlacklistedFromRedirect(const GURL& gurl,
      GURL* out_url) OVERRIDE;
#endif

#if defined(SBROWSER_QUICKLAUNCH_OBSERVER)
  virtual void UpdateTopSitesWithHistory() OVERRIDE;
#endif
 ...
 private:
...
#if defined(SBROWSER_QUICKLAUNCH_OBSERVER)
  void NotifyTopSitesThumbnailChanged();
#endif
  ...
  void FilterTopSitesList(const MostVisitedURLList& old_list,

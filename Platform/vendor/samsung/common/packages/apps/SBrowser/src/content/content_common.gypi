...
########## UI Compositon removal changes
    ['enable_ui_composition_removal==1', {
      'sources': [
		'common/gpu/sbr/SurfaceViewManager.cc',
		'common/gpu/sbr/SurfaceViewManager.h',
		'common/gpu/sbr/SurfaceViewObserver.h',
########## GetBitmap Feature changes
                'common/android/sbr/surface_callback.h',
	        'common/android/sbr/surface_callback.cc',
########## GetBitmap Feature changes
      ],
    }],
########## UI Compositon removal changes

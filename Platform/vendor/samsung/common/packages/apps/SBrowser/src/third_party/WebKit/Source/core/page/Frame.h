...
namespace WebCore {
    ...
    // Per MainFrame we'll allow only 5MB localStorage to prevent malicious site such as filldisk.com
    // TODO: Keep track of Chrome bug fix to be pulled in for Chrome25. Too much changed since Chrome18 on storage front.
	// https://code.google.com/p/chromium/issues/detail?id=178980
    void setLocalStorageAlloted(long alloted, bool add);
    long getLocalStorageAlloted(){return m_localStorageAlloted;}
#endif

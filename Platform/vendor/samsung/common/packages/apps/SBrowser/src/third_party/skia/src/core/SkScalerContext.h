...
protected:
    ...
    virtual bool isColoredBitmap() = 0;
    void setColoredGlyph(bool value){fColoredGlyph = value; fGenerateImageFromPath = !value;}
    bool getColoredGlyph(){return fColoredGlyph;}
#endif

...
class CC_EXPORT TextureLayer : public Layer {
 public:
  ...
  static scoped_refptr<TextureLayer> Create(TextureLayerClient* client, /*SAMSUNG: Ignore blocking in Single Buffer*/bool single_buffer = false);
 ...
 protected:
  TextureLayer(TextureLayerClient* client, bool uses_mailbox, /*SAMSUNG: Ignore blocking in Single Buffer*/bool single_buffer);

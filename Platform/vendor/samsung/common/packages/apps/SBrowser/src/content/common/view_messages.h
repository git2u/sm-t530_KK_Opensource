...
#include <map> // Not under the kikin flag as it could be useful for others.
...
typedef std::map<std::string, std::string> SelectionContextMap;
#endif
...
#if defined(ENABLE_JPN_COMPOSING_REGION)
...
IPC_STRUCT_BEGIN(ViewHostMsg_CreateWindow_Params)
  ...
  // samsung changes
  IPC_STRUCT_MEMBER(std::string, target_href)
...
IPC_STRUCT_BEGIN(ViewHostMsg_ShowPopup_Params)
  ...
  //PrivateIME Options for WebSelectDialog
  IPC_STRUCT_MEMBER(int, privateimeoptions)
#endif
IPC_STRUCT_END()
...
IPC_STRUCT_BEGIN(ViewHostMsg_TextInputState_Params)
  ...
  IPC_STRUCT_MEMBER(bool, spellCheckingEnabled)
  #endif
	#endif 
...
#if defined(SBROWSER_HIDE_URLBAR)
IPC_STRUCT_BEGIN(ViewMsg_HideUrlBarCmd_Params)
  //cmd_type:2 -> SetUrlBarBitmap
  //cmd_type:4 -> SetUrlBarActive
  IPC_STRUCT_MEMBER(int, cmd_type)
  IPC_STRUCT_MEMBER(SkBitmap, urlbar_bitmap)
  IPC_STRUCT_MEMBER(bool, urlbar_active)
  IPC_STRUCT_MEMBER(bool, override_allowed)
IPC_STRUCT_END()

IPC_STRUCT_BEGIN(ViewHostMsg_HideUrlBarCmd_Params)
  //cmd_type:1 -> Ack for Bitmap
  //cmd_type:2 -> Ack for Active
  //cmd_type:4 -> ScrollBegin Notify
  //cmd_type:8 -> ScrollEnd Notify
  IPC_STRUCT_MEMBER(int, cmd_type)
  IPC_STRUCT_MEMBER(int, cmd_data1)
  IPC_STRUCT_MEMBER(int, cmd_data2)
IPC_STRUCT_END()
#endif
...
IPC_MESSAGE_ROUTED2(ViewMsg_GetScrapBitmap, 
						int  /* bitmapWidth */,
						int /* bitmapHeight */);
IPC_MESSAGE_ROUTED2(ViewHostMsg_OnBitmapForScrap,
                    SkBitmap /*bitmap*/,
                    bool /*response*/);
...
IPC_MESSAGE_ROUTED1(ViewHostMsg_SoftBitmap,
                    SkBitmap /* bitmap */)
IPC_MESSAGE_ROUTED5(ViewMsg_ReCaptureSoftBitmap, 
			int  /* x */,
			int /* y */,
			int /* height */,
                     float /*pageScaleFactor*/,
                     bool /*fromPageLoadFinish*/)
IPC_MESSAGE_ROUTED2(ViewHostMsg_UpdateReCaptureSoftBitmap,
                    SkBitmap /* bitmap */,
                    bool /*fromPageLoadFinish*/)
#endif
...
IPC_MESSAGE_ROUTED0(ViewMsg_PrintBegin)


IPC_MESSAGE_ROUTED1(ViewMsg_PrintPage,
                    int  /* pageNum */)

IPC_MESSAGE_ROUTED0(ViewMsg_PrintEnd)

IPC_MESSAGE_ROUTED1(ViewHostMsg_OnPrintBegin,
					int/*totalPageCount*/)

IPC_MESSAGE_ROUTED2(ViewHostMsg_OnBitmapForPrint,
                    SkBitmap,
                    int /*responseCode*/)
...
IPC_MESSAGE_ROUTED2(ViewMsg_FPAuthStatus,
		            bool, /*enabled*/
		            std::string /*usrName*/)
#endif
...
IPC_MESSAGE_ROUTED0(ViewMsg_DisownOpener)
 ...
 IPC_MESSAGE_ROUTED1(ViewHostMsg_SetBingSearchEngineAsDefault, 
                             bool /* enable */)
 #endif
...
IPC_MESSAGE_ROUTED1(ViewMsg_PasswordEchoEnabled,
                     bool /* online */)
#endif
...
// Requests for selection contexts
IPC_MESSAGE_ROUTED1(ViewMsg_GetSelectionContext,
                                       bool /* should update selection context */)

// Requests for updating selection
IPC_MESSAGE_ROUTED2(ViewMsg_UpdateSelection,
                                       std::string, /* old query */
                                       std::string /* new query */)

// Restores the previous selection
IPC_MESSAGE_ROUTED0(ViewMsg_RestoreSelection)

// Clears the last selection
IPC_MESSAGE_ROUTED0(ViewMsg_ClearSelection)
...
IPC_MESSAGE_ROUTED2(ViewMsg_GetBitmapForCopyImage,int,int)
#endif
#if defined(SBROWSER_SBR_NATIVE_CONTENTVIEW)  && defined(SBROWSER_ENTERKEY_LONGPRESS)
IPC_MESSAGE_ROUTED1(ViewMsg_LongPressOnFocussed,
                     IPC::WebInputEventPointer)
#endif

#if defined(SBROWSER_BLOCK_SENDING_FRAME_MESSAGE)
IPC_MESSAGE_ROUTED1(ViewMsg_NeedToUpdateFrameInfo,
                    bool /*enable*/)
#endif
...
#if defined(SBROWSER_IMAGEDRAG_IMPL)
IPC_MESSAGE_ROUTED3(ViewHostMsg_setBitmapForDragging,SkBitmap,int,int) 
#endif 
...
IPC_MESSAGE_ROUTED1(ViewHostMsg_SetFontBoostingModeEnabled,
                             bool /* enable */)
...
// --------------------------- kikin Modification starts ---------------------------
#if defined (SBROWSER_KIKIN)
IPC_MESSAGE_ROUTED1(ViewHostMsg_SelectionContextExtracted,
                                                       SelectionContextMap /* Selection context */)
#endif
// ---------------------------  kikin Modification ends  ---------------------------

#if defined(SBROWSER_FORM_NAVIGATION) 
IPC_MESSAGE_ROUTED0(ViewMsg_MoveToPrev)
IPC_MESSAGE_ROUTED0(ViewMsg_MoveToNext)
IPC_MESSAGE_ROUTED0(ViewHostMsg_OnCloseSelectPopup)
...
IPC_MESSAGE_ROUTED0(ViewMsg_getSelectionVisiblity)
IPC_MESSAGE_ROUTED1(ViewHostMsg_setSelectionVisible,bool)
IPC_MESSAGE_ROUTED0(ViewMsg_UnmarkSelection)
IPC_MESSAGE_ROUTED0(ViewMsg_getSelectionrect)
IPC_MESSAGE_ROUTED1(ViewHostMsg_updateSelectionRect,gfx::Rect)
#endif
#if defined(SBROWSER_FP_SUPPORT)
IPC_MESSAGE_ROUTED0(ViewHostMsg_NotifyAutofillBegin)
#endif
#if defined(SBROWSER_TEXT_SELECTION) && defined(SBROWSER_HTML_DRAG_N_DROP)
IPC_MESSAGE_ROUTED0(ViewMsg_GetSelectionMarkup)
IPC_MESSAGE_ROUTED1(ViewHostMsg_SelectedMarkup, string16)
#endif

#if defined (SBROWSER_MULTIINSTANCE_DRAG_DROP)
IPC_MESSAGE_ROUTED3(ViewMsg_HandleSelectionDrop, int, int, string16)
#endif

#if defined (SBROWSER_HANDLE_MOUSECLICK_CTRL)
IPC_MESSAGE_ROUTED2(ViewMsg_HandleMouseClickWithCtrlkey, int, int)
IPC_MESSAGE_ROUTED1(ViewHostMsg_OpenUrlInNewTab, string16)
#endif

#if defined (SBROWSER_SCROLL_INPUTTEXT)
IPC_MESSAGE_ROUTED1(ViewMsg_ScrollEditWithCursor, int )
IPC_MESSAGE_ROUTED2(ViewHostMsg_UpdateTextFieldBounds 
                                          ,gfx::Rect // Edit field rect
                                          ,bool )
#endif
// SAMSUNG : SmartClip >>
#if defined(SBROWSER_SMART_CLIP) 
IPC_MESSAGE_ROUTED4(ViewMsg_RequestSmartClipData, int, int, int, int);
IPC_MESSAGE_ROUTED1(ViewHostMsg_SmartClipDataExtracted, string16);
#endif
// SAMSUNG : SmartClip <<

// SAMSUNG: Reader >>
#if defined(SBROWSER_READER_NATIVE)
IPC_MESSAGE_ROUTED1(ViewHostMsg_OnRecognizeArticleResult, bool);
#endif
// SAMSUNG: Reader <<
...
#if defined(SBROWSER_HIDE_URLBAR)
IPC_MESSAGE_ROUTED1(ViewMsg_HideUrlBarCmd,
                    ViewMsg_HideUrlBarCmd_Params /* ViewMsg Params for HideUrlBar Cmd*/)
IPC_MESSAGE_ROUTED1(ViewHostMsg_HideUrlBarCmd,
                    ViewHostMsg_HideUrlBarCmd_Params/* ViewHostMsg Params for HideUrlBar Cmd*/)
#endif

#if defined(SBROWSER_FLUSH_PENDING_MESSAGES)
IPC_MESSAGE_ROUTED0(ViewMsg_FlushPendingMessages)
IPC_MESSAGE_ROUTED0(ViewHostMsg_DidFlushPendingMessages)
#endif

#if defined(SBROWSER_FLING_END_NOTIFICATION_CANE)
IPC_MESSAGE_ROUTED1(ViewMsg_FlingAnimationCompleted, bool)
#endif

#if defined(SBROWSER_KEYLAG)
IPC_MESSAGE_ROUTED1(ViewMsg_DeferrJavaScript, bool)
#endif

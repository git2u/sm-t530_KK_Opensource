...
AutofillPopupViewAndroid::~AutofillPopupViewAndroid() {
  ...
  if (!java_object_.is_null())
    Java_AutofillPopupGlue_onNativeDestroyed(env, java_object_.obj());
}
...
void AutofillPopupViewAndroid::Hide() {
  ...
  // delete this; // Crash P131224-01836
}
...
// Crash P131224-01836 ++
void AutofillPopupViewAndroid::Destroy(JNIEnv* env, jobject obj) {
  if (controller_) {
    controller_->Destroy();
  }
  controller_ = 0;

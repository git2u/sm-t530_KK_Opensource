...
void OverscrollGlow::AxisRelease(int axis) {
    switch(axis){
        case AXIS_X : edge_effects_[EdgeEffect::EDGE_LEFT]->Finish();
                      edge_effects_[EdgeEffect::EDGE_RIGHT]->Finish();
                      break;
        case AXIS_Y : edge_effects_[EdgeEffect::EDGE_TOP]->Finish();
                      edge_effects_[EdgeEffect::EDGE_BOTTOM]->Finish();
                      break;
    }
}

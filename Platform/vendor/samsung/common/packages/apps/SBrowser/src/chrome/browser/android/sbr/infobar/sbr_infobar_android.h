#ifndef CLANK_NATIVE_FRAMEWORK_SBR_INFOBAR_ANDROID_H_
#define CLANK_NATIVE_FRAMEWORK_SBR_INFOBAR_ANDROID_H_
#pragma once
...
class InfoBarContainerAndroid : public content::NotificationObserver {
 ...
 bool ShouldShowAutoLoginInfoBar(content::WebContents* web_contents,
  ...
  void RemovePendingInfoBars(content::WebContents* tab_contents);

  // Creates all existing infobars for the |tab_contents|.
 // void UpdateInfoBars(content::WebContents* tab_contents);
...
#endif  // CLANK_NATIVE_FRAMEWORK_SBR_INFOBAR_ANDROID_H_

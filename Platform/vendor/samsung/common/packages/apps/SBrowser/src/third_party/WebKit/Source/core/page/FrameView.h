...
public:
    ...
    void updateCompositingLayerIfNeeded();
#endif
    void updateCompositingLayersAfterStyleChange();
    void updateCompositingLayersAfterLayout();
#if defined(SBROWSER_CSS_TOUCHMOVE_EVENT_FIX)
    void setShouldUpdateTouchEventTargetRects() { m_shouldUpdateTouchEventTargetRects = true; }
#endif
...
#if defined(SBROWSER_CSS_ANIMATION_PERFORMANCE_IMPROVEMENT_3)
    int m_savedCompositingUpdateType; 
#endif
...
#endif
#if defined(SBROWSER_CSS_TOUCHMOVE_EVENT_FIX)
    bool m_shouldUpdateTouchEventTargetRects;
#endif
};

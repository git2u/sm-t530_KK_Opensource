...
class PassThroughImageTransportSurface
 ...
 public:
  ...
  #if defined(SBROWSER_GRAPHICS_UI_COMPOSITOR_REMOVAL)
  //SurfaceView Observer Implementation
  virtual void OnSurfaceViewCreated(const gfx::GLSurface* surface) OVERRIDE;
  virtual void OnSurfaceViewChanged(const gfx::GLSurface* surface) OVERRIDE;
  virtual void OnSurfaceViewDeleted(const gfx::GLSurface* surface) OVERRIDE;
  virtual bool HaveContext() OVERRIDE;

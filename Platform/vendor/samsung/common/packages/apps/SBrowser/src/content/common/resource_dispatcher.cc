...
IPCResourceLoaderBridge::IPCResourceLoaderBridge(
  ...
  request_.is_back_forward_navigation = request_info.is_back_forward_navigation;
#endif
...
bool IPCResourceLoaderBridge::Start(Peer* peer) {
  ...
  if(request_.resource_type == ResourceType::MAIN_FRAME)
	  LOG(INFO) << "  ResourceDispatcher::IPCResourceLoaderBridge::DidStartRequest mainframe request id =" << request_id_;
...
void ResourceDispatcher::OnRequestComplete(
  ...
  if (!request_info)
   ...
   if(request_info->resource_type == ResourceType::MAIN_FRAME)
  	 LOG(INFO) << "  ResourceDispatcher::OnRequestComplete mainframe request id =" << request_id;

...
{ 'return_type': 'void',
  ...
  'arguments': 'GLenum target, GLenum attachment, GLenum textarget, '
...
def EnableRobustnessExt(option, opt, value, parser):
    if (value == 1):
        GL_FUNCTIONS.append({ 'return_type': 'GLenum', 'names': ['glGetGraphicsResetStatusARB', 'glGetGraphicsResetStatusEXT'], 'arguments': 'void', })
...
def main(argv):
  ...
  parser.add_option('--enable-robustness-ext', type="int", action="callback", callback=EnableRobustnessExt)

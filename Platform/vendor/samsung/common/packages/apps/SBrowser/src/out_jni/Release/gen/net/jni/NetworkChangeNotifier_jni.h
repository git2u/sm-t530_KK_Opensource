...
static jint GetConnectionType(JNIEnv* env, jobject obj,
    jint nativePtr) {
  DCHECK(nativePtr) << "GetConnectionType";
  NetworkChangeNotifierDelegateAndroid* native =
      reinterpret_cast<NetworkChangeNotifierDelegateAndroid*>(nativePtr);
  return native->GetConnectionType(env, obj);
}
...
"V", reinterpret_cast<void*>(NotifyConnectionTypeChanged) },
    { "nativeGetConnectionType",
"("
"I"
")"
"I", reinterpret_cast<void*>(GetConnectionType) },
  };

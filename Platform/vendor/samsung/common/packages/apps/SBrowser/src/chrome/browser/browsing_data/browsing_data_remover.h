 ...
 public:
  ...
  class Observer {
   public:
    ...
    virtual void OnGetCurrentCacheSize(std::string currentCacheSize){}
  ...
  void  GetCurrentCacheSizeOnIOThread();
  void  OnGetCurrentCacheSize(std::string currentCacheSize);
#endif //SBROWSER_CHROME_NATIVE_PREFERENCES

...
public:
    ...
    bool isWMLDocument() const { return m_isWML; }
    #endif	
...
protected:
    #if defined (SBROWSER_WML)
    Document(Frame*, const KURL&, bool isXHTML, bool isHTML,bool isWML=false);
    #else
...
// SAMSUNG CHANGE : For keylagging perfomance >>
#if defined (SBROWSER_KEYLAGGING_PERFORMANCE)
    bool m_updateStyleIfNeeded;
#endif
// SAMSUNG CHANGE : For keylagging perfomance <<

#if defined(SBROWSER_FONT_BOOSTING_PREFERENCES)
public:
    void setPageScaleProp(bool flag)
    {
         ...
         * like Safari/Chrome
         */
#ifdef ENABLE_SAMSUNG_WEBKIT_TEXT_SIZE_ADJUST
        m_isPageScalable = flag;
#else
        m_isPageScalable = true;
#endif
    }
...
inline Node::Node(Document* document, ConstructionType type)
   ...
   , isRequestFromPopupZoomer(false)
#endif

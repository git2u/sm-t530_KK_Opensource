...
static const MimeInfo primary_mappings[] = {
  { "text/html", "html,htm" },
#if defined(SBROWSER_PLM_P130704_0652)
  { "application/vnd.wap.xhtml+xml", "wml,xhtml" },
#endif
  { "text/css", "css" },
  { "text/xml", "xml" },
  { "image/gif", "gif" },
...
#if defined(SBROWSER_MEDIA_ADDITIONAL_MIMETYPE)
  "video/3gpp",
#endif
...
static const char* const common_media_codecs[] = {
  ...
  "vorbis",
  "vp8",
#if defined(SBROWSER_MEDIA_ADDITIONAL_CODEC)
  "mp4v",
#endif
  "1"  // WAVE_FORMAT_PCM.
};
...
#if defined(SBROWSER_IMELODY_ALLOW_DOWNLOAD)
  "text/x-imelody", 
#endif
  "text/calendar",
  "text/x-calendar",

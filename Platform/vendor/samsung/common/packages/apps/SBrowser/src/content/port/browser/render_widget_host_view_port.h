...
class CONTENT_EXPORT RenderWidgetHostViewPort : public RenderWidgetHostView,
 ...
 public:
  ...
  // for webselectdialogbox
#if defined(SBROWSER_FORM_NAVIGATION)
  virtual void selectPopupClose() {};
  virtual void selectPopupCloseZero() {};
#endif
  ...
  virtual void OnRecognizeArticleResult(bool isArticle) {}; // SAMSUNG: Reader
#endif
  ...
  virtual void OnHideUrlBarEventNotify(int event, int event_data1, int event_data2) {}
#endif
#if defined(SBROWSER_FLING_END_NOTIFICATION_CANE)
virtual void OnFlingAnimationCompleted(bool page_end){}
#endif
};

...
"V",
  ...
  env->CallVoidMethod(obj,
      method_id, url, incognito);
  base::android::CheckException(env);

}

static base::subtle::AtomicWord g_WebContentsDelegateAndroid_addNewContents = 0;
static jboolean Java_WebContentsDelegateAndroid_addNewContents(JNIEnv* env,
    jobject obj, jint nativeSourceWebContents,
    jint nativeWebContents,
    jint disposition,
...
")"
"Z",
      &g_WebContentsDelegateAndroid_addNewContents);

  jboolean ret =
    env->CallBooleanMethod(obj,
      method_id, nativeSourceWebContents, nativeWebContents, disposition,
          initialPosition, userGesture);
  base::android::CheckException(env);
  return ret;
}
...
static base::subtle::AtomicWord g_WebContentsDelegateAndroid_onTitleUpdated = 0;
static void Java_WebContentsDelegateAndroid_onTitleUpdated(JNIEnv* env, jobject
    obj) {
  /* Must call RegisterNativesImpl()  */
  DCHECK(g_WebContentsDelegateAndroid_clazz);
  jmethodID method_id =
...
")"
"V",
      &g_WebContentsDelegateAndroid_onTitleUpdated);

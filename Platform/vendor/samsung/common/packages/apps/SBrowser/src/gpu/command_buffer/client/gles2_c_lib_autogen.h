...
void GLES2RenderbufferStorageMultisampleIMG(
    GLenum target, GLsizei samples, GLenum internalformat, GLsizei width,
    GLsizei height) {
  gles2::GetGLContext()->RenderbufferStorageMultisampleIMG(
      target, samples, internalformat, width, height);
}
...
void GLES2FramebufferTexture2DMultisampleIMG(
    GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
    GLint level, GLsizei samples) {
  gles2::GetGLContext()->FramebufferTexture2DMultisampleIMG(
      target, attachment, textarget, texture, level, samples);
}
...
NameToFunc g_gles2_function_table[] = {
  ...
  { "glRenderbufferStorageMultisampleIMG", reinterpret_cast<GLES2FunctionPointer>(glRenderbufferStorageMultisampleIMG), },  // NOLINT
  { "glFramebufferTexture2DMultisampleEXT", reinterpret_cast<GLES2FunctionPointer>(glFramebufferTexture2DMultisampleEXT), },  // NOLINT
  { "glFramebufferTexture2DMultisampleIMG", reinterpret_cast<GLES2FunctionPointer>(glFramebufferTexture2DMultisampleIMG), },  // NOLINT

...
static jint Init(JNIEnv* env, jobject obj,
    jint contentViewCorePtr);

// Step 2: method stubs.
static void Destroy(JNIEnv* env, jobject obj,
    jint nativeWebContentsObserverAndroid) {
...
static base::subtle::AtomicWord
    g_WebContentsObserverAndroid_didNavigateMainFrame = 0;
static void Java_WebContentsObserverAndroid_didNavigateMainFrame(JNIEnv* env,
...
")"
"V",
      &g_WebContentsObserverAndroid_didNavigateMainFrame);

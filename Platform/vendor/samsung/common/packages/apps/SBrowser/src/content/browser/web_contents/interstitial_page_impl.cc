...
// SAMSUNG : SmartClip <<
  ...
  virtual void UpdateSoftBitmap(const SkBitmap& bitmap)OVERRIDE;
  virtual void UpdateReCaptureSoftBitmap(const SkBitmap& bitmap, bool fromPageLoadFinish)OVERRIDE;
#endif
#if defined (SBROWSER_PRINT_IMPL)
  virtual void OnBitmapForPrint(const SkBitmap& bitmap, int responseCode)OVERRIDE;
  virtual void OnPrintBegin(int totalPageCount )OVERRIDE;
#endif
#if defined (SBROWSER_SAVEPAGE_IMPL)
  virtual void OnBitmapForScrap(const SkBitmap& bitmap, bool response)OVERRIDE;
  virtual void ScrapPageSavedFileName ( const base::FilePath::StringType& pure_file_name)OVERRIDE;
...
#if defined(SBROWSER_TEXT_SELECTION)   
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedBitmap(const SkBitmap& Bitmap){}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::PointOnRegion(bool isOnRegion){}
 void InterstitialPageImpl::InterstitialPageRVHDelegateView::SetSelectionVisibilty(bool isVisible){}
 void InterstitialPageImpl::InterstitialPageRVHDelegateView::updateSelectionRect(const gfx::Rect& selectionRect){}
#endif
#if defined(SBROWSER_FP_SUPPORT)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::NotifyAutofillBegin(){}
#endif
#if defined (SBROWSER_SCROLL_INPUTTEXT)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnTextFieldBoundsChanged(const gfx::Rect&  input_edit_rect,bool isScrollEnable){}; 
#endif
#if defined (SBROWSER_HANDLE_MOUSECLICK_CTRL)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnOpenUrlInNewTab(const string16&  url){};
#endif
#if defined(SBROWSER_TEXT_SELECTION) && defined(SBROWSER_HTML_DRAG_N_DROP)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::SelectedMarkup(const string16& markup) {}
#endif

// SAMSUNG : SmartClip >>
#if defined(SBROWSER_SMART_CLIP)  
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnSmartClipDataExtracted(const string16& result) {}
#endif
// SAMSUNG : SmartClip <<
#if defined (SBROWSER_SOFTBITMAP_IMPL)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::UpdateSoftBitmap(const SkBitmap& bitmap){}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::UpdateReCaptureSoftBitmap(const SkBitmap& bitmap, bool fromPageLoadFinish){}
#endif

#if defined(SBROWSER_FPAUTH_IMPL)
bool InterstitialPageImpl::InterstitialPageRVHDelegateView::OnCheckFPAuth(){return false;}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnLaunchFingerPrintActivity(){}
#endif

#if defined (SBROWSER_PRINT_IMPL)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnBitmapForPrint(const SkBitmap& bitmap, int responseCode){}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnPrintBegin(int totalPageCount){}
#endif
#if defined (SBROWSER_SAVEPAGE_IMPL)
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnBitmapForScrap(const SkBitmap& bitmap, bool response){}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::ScrapPageSavedFileName ( const base::FilePath::StringType& pure_file_name){}
void InterstitialPageImpl::InterstitialPageRVHDelegateView::OnReceiveBitmapFromCache(const SkBitmap& bitmap){}
#endif
#if defined(SBROWSER_IMAGEDRAG_IMPL)
void InterstitialPageImpl::InterstitialPageRVHDelegateView:: SetBitmapForDragging(const SkBitmap& bitmap,int width, int height){}
#endif
...
void InterstitialPageImpl::InterstitialPageRVHDelegateView::ShowPopupMenu(
    ...
    bool right_aligned,
    #if defined (SBROWSER_SUPPORT) && defined(SBROWSER_FORM_NAVIGATION)
    bool allow_multiple_selection,int privateimeoptions)
    #else

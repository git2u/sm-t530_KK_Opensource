      ...
      'actions': [
        {
          ...
          'variables': {
            ...
            'flag_robustness_ext': 1, #enabled by default
            'conditions': [
              ['use_system_mesa==0', {
              ...
              ['enable_sbrowser_apk==1', { #can only be disabled for sbrowser build
                'conditions': [
                  ['disable_robustness_extension==1', { 
                    'flag_robustness_ext': 0,
                  }],
                ],
              }],
            ]
          ...
          'inputs': [
            '<(generator_path)',
            '<!@(python <(generator_path) --header-paths=<(header_paths) --inputs --enable-robustness-ext=<(flag_robustness_ext))',
          ],
          'outputs': [
          ...
          'action': [
            ...
            '<(gl_binding_output_dir)',
            '--enable-robustness-ext=<(flag_robustness_ext)',
          ],
        },
      ],
      'conditions': [

...
class WebContents : public PageNavigator,
 ...
 public:
  ...
  // Check whether current page is WML page or not based on content MIME Type.
  // Added this API to support WML functionality at app level.
  virtual bool IsWMLPage() = 0;
  #endif
  // Prepare for saving the current web page to disk.
  virtual void OnSavePage() = 0;
#if defined (SBROWSER_SAVEPAGE_IMPL)
  // Inform UI the SavePage path

...
class BASE_EXPORT SysInfo {
 public:
  ...
  // Returns the Android build's PDA.
  static std::string GetAndroidBuildPDA();
#endif

#if defined(SBROWSER_SYSINFO_GETANDROIDCOUNTRYISO)
  // Returns the Android CountryISO code.
  static std::string GetAndroidCountryISO();
#endif
  ...
  static std::string GetAndroidLanguage();
#endif

...
#ifndef ANDROID_CONTENT_BROWSER_ANDROID_INPUT_STREAM_H_
#define ANDROID_CONTENT_BROWSER_ANDROID_INPUT_STREAM_H_
...
#endif //  ANDROID_CONTENT_BROWSER_ANDROID_INPUT_STREAM_H_

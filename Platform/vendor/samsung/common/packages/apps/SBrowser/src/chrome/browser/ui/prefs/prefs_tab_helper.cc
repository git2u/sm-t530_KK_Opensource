...
const char* kPrefsToObserve[] = {
  ...
  ,sbrprefs::kWebKitAllowContentURLAccess
#endif
#if defined(SBROWSER_BINGSEARCH_ENGINE_SET_VIA_JAVASCRIPT)
  ,prefs::kWebKitIsBingAsDefaultSearchEngine, 
#endif
#if defined(SBROWSER_ENABLE_APPNAP) 
	sbrprefs::kEnableAppNap,
#endif
#if defined(SBROWSER_POWER_SAVER_MODE_IMPL)
	sbrprefs::kEnableBgColorOffWhite,
	sbrprefs::kEnableBgColorLightGrey,
	sbrprefs::kEnableBgColorGrey,
	sbrprefs::kDisableGifAnimation,
	sbrprefs::kDisableProgressiveImageDecode,
	sbrprefs::kDisableFilterBitmap,
#endif
#if defined(SBROWSER_ENABLE_ADBLOCKER)
	sbrprefs::kEnableAdBlocker,
#endif
};
...
void PrefsTabHelper::RegisterUserPrefs(
  ...
  registry->RegisterBooleanPref(
      ...
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
 #if defined(SBROWSER_CHROME_NATIVE_PREFERENCES)
  registry->RegisterBooleanPref(sbrprefs::kWebkitOverviewModeEnabled,
                             pref_defaults.overview_mode_enabled,
                             user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif //SBROWSER_CHROME_NATIVE_PREFERENCES
  // SAMSUNG_CHANGE : FontBoosting mode
#if defined(SBROWSER_FONT_BOOSTING_PREFERENCES)
  registry->RegisterBooleanPref(sbrprefs::kWebKitFontBoostingModeEnabled,
     			     pref_defaults.fontboosting_mode_enabled,
                             user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif // SBROWSER_FONT_BOOSTING_PREFERENCES
  // SAMSUNG_CHANGE : FontBoosting mode
 ...
 registry->RegisterBooleanPref(prefs::kWebKitPluginsEnabled,
  ...
  registry->RegisterBooleanPref(
      sbrprefs::kWebKitAllowContentURLAccess,
      pref_defaults.allow_content_url_access,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
#if defined(SBROWSER_USE_WIDE_VIEWPORT)
  registry->RegisterBooleanPref(
      sbrprefs::kWebKitUseWideViewport,
      pref_defaults.use_wide_viewport,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
#if defined(SBROWSER_IMIDEO_PREFERENCES)
  registry->RegisterIntegerPref(
      prefs::kWebkitImideoDebugMode,
      pref_defaults.imideo_debug_mode,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
...
#endif
#if defined(SBROWSER_TEXT_ENCODING)
registry->RegisterStringPref(prefs::kGlobalDefaultCharset,
                                     pref_defaults.default_encoding,
                                    user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
#endif
  registry->RegisterLocalizedStringPref(
      prefs::kDefaultCharset,
      ...
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
#if defined(SBROWSER_BINGSEARCH_ENGINE_SET_VIA_JAVASCRIPT)
  registry->RegisterBooleanPref(prefs::kWebKitIsBingAsDefaultSearchEngine,
                             pref_defaults.is_bing_as_default_search_engine,
                             user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
#endif										
  ...
  registry->RegisterBooleanPref(
      prefs::kWebKitUsesUniversalDetector,
      pref_defaults.uses_universal_detector,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  #else
  ...
  registry->RegisterStringPref(
      ...
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#if defined(SBROWSER_ENABLE_APPNAP) 
	  registry->RegisterBooleanPref(sbrprefs::kEnableAppNap,
						   pref_defaults.enable_appnap,
						   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
#if defined(SBROWSER_POWER_SAVER_MODE_IMPL)
	  registry->RegisterBooleanPref(sbrprefs::kEnableBgColorOffWhite,
								 pref_defaults.enable_bgcolor_Offwhite,
								 user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
	  registry->RegisterBooleanPref(sbrprefs::kEnableBgColorLightGrey,
									   pref_defaults.enable_bgcolor_lightgrey,
									   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
	  registry->RegisterBooleanPref(sbrprefs::kEnableBgColorGrey,
								 pref_defaults.enable_bgcolor_grey,
								 user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
	  
	  registry->RegisterBooleanPref(sbrprefs::kDisableGifAnimation,
									   pref_defaults.disable_gif_animation,
									   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);

	  registry->RegisterBooleanPref(sbrprefs::kDisableProgressiveImageDecode,
									   pref_defaults.disable_progressive_image_decoding,
									   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);

	  registry->RegisterBooleanPref(sbrprefs::kDisableFilterBitmap,
									   pref_defaults.disable_filter_bitmap,
									   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif
#if defined(SBROWSER_ENABLE_ADBLOCKER)
	  registry->RegisterBooleanPref(sbrprefs::kEnableAdBlocker,
									   pref_defaults.enable_adblocker,
								   user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
#endif	

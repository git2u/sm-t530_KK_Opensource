...
#if defined(SBROWSER_DEVICEMOTION_IMPL)
  channel_->AddFilter(new device_motion::MessageFilter());
#endif
...
void RenderProcessHostImpl::PropagateBrowserCommandLineToRenderer(
  ...
  static const char* const kSwitchNames[] = {
    ...
    switches::kEnablePowerSaverMode,
    switches::kDisableProgressiveImageDecoding,
    switches::kDisableGIFAnimation,
#endif
#if defined(SBROWSER_ENABLE_APPNAP)  
	switches::kEnableAppNap,
#endif
#if defined(OS_ANDROID)
    ...
    switches::kDisableNativeBufferTextures,
    switches::kEnableNativeBufferTextures,
#endif
    // SAMSUNG: Ignore blocking in Single Buffer >>
    switches::kDisableSingleBufferHint,
    switches::kEnableSingleBufferHint,
    // SAMSUNG: Ignore blocking in Single Buffer <<
#if !defined (GOOGLE_CHROME_BUILD)
	...
	switches::kEnableSingleCompositor,
#endif
    ...
    cc::switches::kEnableHideUrlBar,
#endif
#if defined(SBROWSER_SUPPORT_GLOW_EDGE_EFFECT)
    cc::switches::kEnableEdgeGlowEffect,
#endif
...
void RenderProcessHostImpl::OnChannelError() {
  LOG(ERROR) <<"[UI][IPC] [RenderProcessHostImpl][OnChannelError]";
...
void RenderProcessHostImpl::ProcessDied(bool already_dead) {
	LOG(INFO)  << "TouchLockup RenderProcessHostImpl::ProcessDied already_dead = " << already_dead;

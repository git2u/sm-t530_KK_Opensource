...
#if defined(SBROWSER_USING_SAMSUNG_FONTS)
#define SYSTEM_FONTS_FILE "/system/etc/system_fonts_sbrowser.xml"
#define FALLBACK_FONTS_FILE "/system/etc/fallback_fonts_sbrowser.xml"
#else

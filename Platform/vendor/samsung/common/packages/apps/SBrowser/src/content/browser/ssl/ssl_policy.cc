...
// B2B Request : give the option to proceed anyway even in the revoked case
    ...
    case net::ERR_CERT_UNABLE_TO_CHECK_REVOCATION:
      ...
      // bar.
    // it shouldn't be ignored. A user must be informed revocation status.
    // requested by KNOX team
      handler->ContinueRequest();
      break;
#endif

...
TEST_F(GLES2FormatTest, RenderbufferStorageMultisampleIMG) {
  cmds::RenderbufferStorageMultisampleIMG& cmd =
      *GetBufferAs<cmds::RenderbufferStorageMultisampleIMG>();
  void* next_cmd = cmd.Set(
      &cmd,
      static_cast<GLenum>(11),
      static_cast<GLsizei>(12),
      ...
      static_cast<GLsizei>(15));
  EXPECT_EQ(
      static_cast<uint32>(cmds::RenderbufferStorageMultisampleIMG::kCmdId),
            cmd.header.command);
  EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
  EXPECT_EQ(static_cast<GLenum>(11), cmd.target);
  EXPECT_EQ(static_cast<GLsizei>(12), cmd.samples);
...
TEST_F(GLES2FormatTest, FramebufferTexture2DMultisampleIMG) {
  cmds::FramebufferTexture2DMultisampleIMG& cmd =
      *GetBufferAs<cmds::FramebufferTexture2DMultisampleIMG>();
  void* next_cmd = cmd.Set(
      &cmd,
      static_cast<GLenum>(11),
      static_cast<GLenum>(12),
      ...
      static_cast<GLsizei>(16));
  EXPECT_EQ(
      static_cast<uint32>(cmds::FramebufferTexture2DMultisampleIMG::kCmdId),
            cmd.header.command);
  EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
  EXPECT_EQ(static_cast<GLenum>(11), cmd.target);
  EXPECT_EQ(static_cast<GLenum>(12), cmd.attachment);

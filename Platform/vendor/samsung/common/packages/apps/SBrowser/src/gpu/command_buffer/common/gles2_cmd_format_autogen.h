...
struct RenderbufferStorageMultisampleIMG {
  typedef RenderbufferStorageMultisampleIMG ValueType;
  static const CommandId kCmdId = kRenderbufferStorageMultisampleIMG;
  static const cmd::ArgFlags kArgFlags = cmd::kFixed;
...
COMPILE_ASSERT(sizeof(RenderbufferStorageMultisampleIMG) == 24,
               Sizeof_RenderbufferStorageMultisampleIMG_is_not_24);
COMPILE_ASSERT(offsetof(RenderbufferStorageMultisampleIMG, header) == 0,
               OffsetOf_RenderbufferStorageMultisampleIMG_header_not_0);
COMPILE_ASSERT(offsetof(RenderbufferStorageMultisampleIMG, target) == 4,
               OffsetOf_RenderbufferStorageMultisampleIMG_target_not_4);
COMPILE_ASSERT(offsetof(RenderbufferStorageMultisampleIMG, samples) == 8,
               OffsetOf_RenderbufferStorageMultisampleIMG_samples_not_8);
COMPILE_ASSERT(
    offsetof(RenderbufferStorageMultisampleIMG, internalformat) == 12,
               OffsetOf_RenderbufferStorageMultisampleIMG_internalformat_not_12);  // NOLINT
COMPILE_ASSERT(offsetof(RenderbufferStorageMultisampleIMG, width) == 16,
               OffsetOf_RenderbufferStorageMultisampleIMG_width_not_16);
COMPILE_ASSERT(offsetof(RenderbufferStorageMultisampleIMG, height) == 20,
               OffsetOf_RenderbufferStorageMultisampleIMG_height_not_20);
...
struct FramebufferTexture2DMultisampleIMG {
  typedef FramebufferTexture2DMultisampleIMG ValueType;
  static const CommandId kCmdId = kFramebufferTexture2DMultisampleIMG;
  static const cmd::ArgFlags kArgFlags = cmd::kFixed;
...
COMPILE_ASSERT(sizeof(FramebufferTexture2DMultisampleIMG) == 28,
               Sizeof_FramebufferTexture2DMultisampleIMG_is_not_28);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, header) == 0,
               OffsetOf_FramebufferTexture2DMultisampleIMG_header_not_0);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, target) == 4,
               OffsetOf_FramebufferTexture2DMultisampleIMG_target_not_4);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, attachment) == 8,
               OffsetOf_FramebufferTexture2DMultisampleIMG_attachment_not_8);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, textarget) == 12,
               OffsetOf_FramebufferTexture2DMultisampleIMG_textarget_not_12);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, texture) == 16,
               OffsetOf_FramebufferTexture2DMultisampleIMG_texture_not_16);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, level) == 20,
               OffsetOf_FramebufferTexture2DMultisampleIMG_level_not_20);
COMPILE_ASSERT(offsetof(FramebufferTexture2DMultisampleIMG, samples) == 24,
               OffsetOf_FramebufferTexture2DMultisampleIMG_samples_not_24);

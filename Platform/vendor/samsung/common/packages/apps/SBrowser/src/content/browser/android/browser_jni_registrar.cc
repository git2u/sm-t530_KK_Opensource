...
#include "content/browser/android/sbr/sbr_find_on_page.h"
...
#include "content/browser/android/sbr/sbr_content_settings.h"
#endif

#if defined (SBROWSER_SAVEPAGE_IMPL)
#include "content/browser/android/sbr/sbrcontentprotocoladapter/sbr_android_protocol_handler.h"
#include "content/browser/android/sbr/sbrcontentprotocoladapter/sbr_input_stream_impl.h"
#endif
...
#if defined (SBROWSER_SBR_NATIVE_CONTENTVIEW)  
  { "FindOnPage", content::RegisterFindOnPage },
    { "SbrFindOnPageDelegate", content::RegisterSbrFindOnPageDelegate },  
#endif  
#if defined (SBROWSER_SAVEPAGE_IMPL)

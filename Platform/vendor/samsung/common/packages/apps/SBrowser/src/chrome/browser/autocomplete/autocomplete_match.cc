...
std::string AutocompleteMatch::TypeToString(Type type) {
  const char* strings[] = {
    ...
    "VOICE-SUGGEST",           //3 dummy items are used in SBrowserSuggestions.java.
    "SAVEPAGE-SUGGEST",        //This is required to pass COMPILE_ASSERT below.
    "OPERATOR-SUGGEST",        //SuggestionListAdapater.java:getSuggestionIconType should use enum rather than numbers
    "search-term-result"       //anish.p: used in experimental smart suggest
#endif
  };

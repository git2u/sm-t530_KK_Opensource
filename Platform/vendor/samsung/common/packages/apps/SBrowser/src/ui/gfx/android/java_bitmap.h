...
UI_EXPORT base::android::ScopedJavaLocalRef<jobject> CreateJavaBitmapWith565Config(
    const gfx::Size& size);

UI_EXPORT base::android::ScopedJavaLocalRef<jobject> ConvertToJavaBitmapWith565Config(
    const SkBitmap* skbitmap);
#endif
#if defined(SBROWSER_HIDE_URLBAR)
UI_EXPORT SkBitmap ConvertToSkBitmap( base::android::ScopedJavaLocalRef<jobject> jbitmap);
#endif

...
// should be.
//SAMSUNG CHANGE: reducing keep alive timeout to reduce power consumption.
//int g_unused_idle_socket_timeout_s = 10;
int g_unused_idle_socket_timeout_s = 1;
//SAMSUNG CHANGE

// The maximum duration, in seconds, to keep used idle persistent sockets alive.
//SAMSUNG CHANGE: Reduce keep alive time out
//int g_used_idle_socket_timeout_s = 300;  // 5 minutes
int g_used_idle_socket_timeout_s = 1; //2;
//SAMSUNG CHANGE

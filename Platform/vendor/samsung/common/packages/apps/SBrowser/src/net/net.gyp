...

{
  'variables': {
    ...
    # The use of mmap() is verified in the latest devices and does not have any
    # issue. It also improves battery consumption. So disabling the following flag
    # for all conditions.
    'posix_avoid_mmap%': 0,
    'conditions': [
  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['enable_sbrowser_apk==1', {
          'includes': ['sbr/sbr_net_features.gypi'],
            'conditions': [
              ['enable_cac_feature==1', {
                'dependencies': [
                  '../build/sbr/sbr_plaform_support.gypi:smartcard_certificate',
                ],
              }],

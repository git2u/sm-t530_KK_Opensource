...
class CC_EXPORT LayerTreeImpl {
 public:
  ...
  LayerImpl* web_root_layer() { return web_root_layer_; }
  void set_web_root_layer(LayerImpl* layer_impl) {
    web_root_layer_ = layer_impl;
  }

  LayerImpl* urlbar_layer() { return urlbar_layer_; }
  void set_urlbar_layer(LayerImpl* layer_impl) {
    urlbar_layer_ = layer_impl;
  }
  bool urlbar_active();
...
#if defined(SBROWSER_HIDE_URLBAR)
  LayerImpl* urlbar_layer_;
  LayerImpl* web_root_layer_;
#endif

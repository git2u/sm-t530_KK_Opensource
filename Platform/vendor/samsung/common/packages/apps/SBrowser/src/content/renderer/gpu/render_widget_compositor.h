...
class RenderWidgetCompositor : public WebKit::WebLayerTreeView,
 ...
 public:
  ...
  virtual void UpdateCompositingLayersIfNeeded() OVERRIDE;
#endif
...
#endif
#if defined(SBROWSER_HIDE_URLBAR)
    virtual  void HideUrlBarEventNotify(int event, int event_data1, int event_data2) OVERRIDE;
#endif
#if defined(SBROWSER_FLING_END_NOTIFICATION_CANE)
   virtual  void FlingAnimationCompleted(bool page_end) OVERRIDE;
#endif

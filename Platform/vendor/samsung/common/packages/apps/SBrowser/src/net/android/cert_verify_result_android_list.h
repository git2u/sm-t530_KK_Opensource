...
// Certificate is not trusted because it is not able to check revocation status
CERT_VERIFY_RESULT_ANDROID(UNABLE_TO_CHECK_REVOCATION, -7)

// Certificate is not trusted because it is revoked
CERT_VERIFY_RESULT_ANDROID(REVOKED, -8)
#endif

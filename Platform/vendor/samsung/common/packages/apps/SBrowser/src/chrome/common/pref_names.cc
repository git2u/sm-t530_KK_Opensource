...
const char kWebkitImideoDebugMode[] = "webkit.webprefs.imideo_debug_mode";
#endif
// ------------------- kikin Modification Starts --------------------
#if defined(SBROWSER_KIKIN)
const char kWebKitKikinEnabled[] = "webkit.webprefs.kikin_enabled";
#endif

#if defined(SBROWSER_BINGSEARCH_ENGINE_SET_VIA_JAVASCRIPT)
const char kWebKitIsBingAsDefaultSearchEngine[] = "webkit.webprefs.is_bing_as_default_search_engine";
#endif  
...
const char kWebNotificationType[] = "browser.web_notification_type";

...
string PhoneNumberUtil::kOriginalPhoneNumber="";
#endif
...
#if defined(SBROWSER_PHONENUMBER_DETECTION)
void PhoneNumberUtil::SetOriginalPhoneNumber(const string& extracted_number){
	kOriginalPhoneNumber =extracted_number.c_str();
}

string PhoneNumberUtil::GetOriginalPhoneNumber(){
	return kOriginalPhoneNumber;
}
#endif
...
PhoneNumberUtil::ErrorType PhoneNumberUtil::ParseHelper(
  ...
  SetOriginalPhoneNumber(number_to_parse);
#else

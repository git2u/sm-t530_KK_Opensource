...
#ifndef CONTENT_BROWSER_ANDROID_INPUT_STREAM_READER_H_
#define CONTENT_BROWSER_ANDROID_INPUT_STREAM_READER_H_
...
class InputStreamReader {
 public:
  ...
  InputStreamReader(content::InputStream* stream);
...
#endif //  CONTENT_BROWSER_ANDROID_INPUT_STREAM_READER_H_
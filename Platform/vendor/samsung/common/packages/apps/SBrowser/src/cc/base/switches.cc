...
// Enables HideUrlBar Feature
const char kEnableHideUrlBar[] =    "enable-hide-urlbar";
#endif

#if defined(SBROWSER_SUPPORT_GLOW_EDGE_EFFECT)
// Enables EdgeGlow Effect Feature
const char kEnableEdgeGlowEffect[] =    "enable_edge_gloweffect";
#endif

#if defined(SBROWSER_DOUBLETAP_PATENT_CHANGE)
// Enables Double Tap Patent Changes

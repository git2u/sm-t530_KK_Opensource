...
#ifndef CHROME_BROWSER_ANDROID_SBR_AUTOCOMPLETE_H_
#define CHROME_BROWSER_ANDROID_SBR_AUTOCOMPLETE_H_
...
bool RegisterSbrAutocompleteBridge(JNIEnv* env);

#endif  // CHROME_BROWSER_ANDROID_SBR_AUTOCPMPLETE_H_

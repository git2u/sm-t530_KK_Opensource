...
const char kDisableGpuShaderDiskCache[]     = "disable-gpu-shader-disk-cache";
    ...
    const char kEnableSingleCompositor[]        = "single-compositor";
    const char kDisableSingleCompositor[]       = "disable-single-compositor";
    const char kEnsureSurfaceWorkaround[]          = "ensure-surface-workaround";
    const char kDisableSurfaceWorkaround[]          = "disable-surface-workaround";
#endif
...
#if defined(SBROWSER_GRAPHICS_UI_COMPOSITOR_REMOVAL)
  kEnableSingleCompositor,
  kEnsureSurfaceWorkaround,
#endif
};
